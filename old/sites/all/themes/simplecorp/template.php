...
function simplecorp_preprocess_page(&$variables){
	...
	$string = $variables['page']['content']['system_main']['nodes'][$nid]['body'][0]['#markup'];
	$page_content =  preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1', $string);
	#krumo($page_content);
	$variables['page']['content']['system_main']['nodes'][$nid]['body'][0]['#markup'] = '<div id="node_content">'.$page_content.'</div>';
	#krumo($variables['page']['content']['system_main']['nodes'][$nid]['body'][0]['#markup']);
...
function simplecorp_theme(){
	...
	//  'path' => drupal_get_path('theme', 'simplecorp') . '/templates',
	  ...
	  'preprocess functions' => array('simplecorp_preprocess_user_profile'),
	 );

	 $items['user_login'] = array(
		'render element' => 'form',
		'template' => 'user-login',
		'preprocess functions' => array('simplecorp_preprocess_user_login'),
	);
...
function simplecorp_preprocess_user_login(&$variables) {

	$variables['form']['name']['#description'] = '';
	$variables['form']['actions']['#attributes'] = array('style' => array('float:left;'));
	//$variables['form']['name']['#title'] = '';
	$variables['form']['pass']['#description'] = '';
	//$variables['form']['pass']['#title'] = '';
	/* $variables['form']['name']['#attributes'] = array('autocomplete' => 'off');
	$variables['form']['pass']['#attributes'] = array('autocomplete' => 'off');
	$variables['form']['name']['#attributes']['placeholder'] = 'USERNAME';
	$variables['form']['name']['#size'] = 30;
	$variables['form']['pass']['#attributes']['placeholder'] = 'PASSWORD';
	$variables['form']['pass']['#size'] = 30; 
	
	$variables['form']['captcha']['#description'] = '';
	$variables['form']['captcha']['captcha_widgets']['captcha_response']['#description'] = '';*/
}
...
//function simplecorp_preprocess_user_profile(&$variables) {

	/*unset($variables);
	$variables['elements']['summary']['#title'] = 'Test ....';
	$variables['user_profile']['summary']['#title'] = 'Test ....';*/
	

	//krumo($variables);

	#$variables['welcome_message'] = "Welcome to e-PBGSBS Management System.";
