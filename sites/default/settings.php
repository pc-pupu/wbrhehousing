...
//ini_set('session.cookie_domain', '.wb.gov.in');
...
// ini_set('session.cookie_samesite', 'None');//this is required for login from hrms
...
$base_url = 'http://housing.example.com';
...
$conf['hmac_secret'] = '1Po/Rx7oUnNzy9QZ7NZJjA==';
//$conf['hmac_secret'] = 'DDThkqkxlOYQzpZUbqnfEGir5mWHV5mY';
$conf['secret'] = 'DDThkqkxlOYQzpZUbqnfEGir5mWHV5mY';
// $conf['iv'] = 'ykDWpfWyXXjTY0bguBzKmcEFZTINLPEe';
$conf['iv'] = 'ykDWpfWyXXjTY0bg';

$conf['hmac_secret_me'] = '1Po/Pt8oRnNzy9QZ7NZJjA=='; 

$conf['uat_hrms_url']='https://uat.wbifms.gov.in';
$conf['prod_hrms_url']='https://www.wbifms.gov.in';
$conf['prod_hrms_url_without']='https://wbifms.gov.in';
